...
const Footer = () => {
  return (
    <footer className="border-accent-alt mx-auto w-full max-w-4xl border-t">
      <div className="text-secondary-text text-xs-sm flex flex-col items-center justify-between gap-2 p-3 font-bold md:flex-row md:justify-around">
